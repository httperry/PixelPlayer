...
# Replace getLibraryPlaylists part inside getUserPlaylists:
# The function is `suspend fun getUserPlaylists()`
q = "    suspend fun getUserPlaylists(): List<com.theveloper.pixelplay.data.model.Playlist> {"
idx = text.find(q)
...
"""
    ...
    with open("app/src/main/java/com/theveloper/pixelplay/data/network/ytmusic/YTMusicRepository.kt", "w") as f:
        f.write(text)
    print("Done getLibraryPlaylists")
else:
    print("Failed")
