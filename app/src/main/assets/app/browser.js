  ...
  var BotGuardClient = class _BotGuardClient {
    ...
    async snapshot(args, timeout = 3e3) {
      return await Promise.race([
        ...
        new Promise(
          (_, reject) => setTimeout(() => reject(new BGError("TIMEOUT", "VM operation timed out")), timeout)
        )
      ]);
    }
    /**
